...
#Load Dataset
dataset = pd.read_csv('scenario12.binetflow')
dataset = dataset.dropna()
print(dataset.sample(5))
dataset = dataset[dataset['Label'].str.contains('Botnet|Normal')] #Getting the botnet data
...
cm = confusion_matrix(ytest,prediction_dt)
#Plot the confusion matrix.
sns.heatmap(cm,
            annot=True,
            fmt='g',
            xticklabels=['Botnet', 'Legitimate'],
            yticklabels=['Botnet', 'Legitimate'])
